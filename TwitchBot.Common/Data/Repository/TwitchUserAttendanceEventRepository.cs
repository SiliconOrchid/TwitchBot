...
{
    public class TwitchUserAttendanceEventRepository : GenericRepository<TwitchUserAttendanceEvent>, ITwitchUserAttendanceEventRepository
    {

        public TwitchUserAttendanceEventRepository(
